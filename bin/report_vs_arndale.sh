...
echo 'python test.py -c tests_updates/$inifile -s $section_param -b ~/DI_TEST -e P4 -m 3 -T --skip-with-record --binary-search $binary_search_param --exec-cmd-post "cd /mnt/DI_TEST/DI_Script/compare/PBI/Test_In_Python; python test_reporter.py -c $cfgfile -t $section_param -b 2020610 -o ~/ -d -s $thresh_hold -i" '
python test.py -c tests_updates/$inifile -s $section_param -b ~/DI_TEST -e P4 -m 3 -T --skip-with-record --binary-search $binary_search_param --exec-cmd-post "cd /mnt/DI_TEST/DI_Script/compare/PBI/Test_In_Python; python test_reporter.py -c $cfgfile -t $section_param -b 2020610 -o ~/ -d -s $thresh_hold -i"
