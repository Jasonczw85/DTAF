...
echo 'python test.py -c tests_updates/$inifile -s $section_param -b ~/DI_TEST -e P4 -m 2 -T --binary-search $binary_search_param --exec-cmd-post "cd /mnt/DI_TEST/DI_Script/Compatibility_Tests; python test_reporter.py -c $cfgfile -t $section_param -o test -b $base_line -d -s $thresh_hold -i" '

python test.py -c tests_updates/$inifile -s $section_param -b ~/DI_TEST -e P4 -m 2 -T --binary-search $binary_search_param --exec-cmd-post "cd /mnt/DI_TEST/DI_Script/Compatibility_Tests; python test_reporter.py -c $cfgfile -t $section_param -o test -b $base_line -d -s $thresh_hold -i"
